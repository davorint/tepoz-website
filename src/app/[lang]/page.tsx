  ...
  return (
    <main className="min-h-screen overflow-x-hidden">
      <div className="relative h-screen w-full overflow-hidden">
        ...
        <div className="absolute inset-0 z-[1]" suppressHydrationWarning>
        ...
        <div className="relative z-10 flex h-full items-center justify-center px-4">
          <div className="max-w-5xl text-center">
            <h1 className="mb-6 text-7xl md:text-9xl lg:text-[10rem] font-bebas tracking-wider motion-safe:animate-fade-in-up motion-safe:animation-delay-500ms text-shadow-lg hover:scale-105 md:hover:scale-110 transition-transform duration-500 cursor-pointer touch-manipulation select-none" suppressHydrationWarning>
              <span className="text-blue-600">TO</span>
              <span className="text-sky-500">DO</span>
              <span className="text-tepoztlan-sunset">TEPOZ</span>
            </h1>
            <p className="mx-auto max-w-2xl text-lg md:text-xl lg:text-2xl text-white mb-8 motion-safe:animate-fade-in-up motion-safe:animation-delay-700ms text-shadow-md hover:text-yellow-100 transition-colors duration-300 cursor-pointer touch-manipulation font-montserrat font-light" suppressHydrationWarning>
              {lang === 'es' 
