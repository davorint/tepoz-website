    ...
    <ClientOnly fallback={
      <div className="relative h-screen w-full overflow-hidden">
        ...
        <div className="relative z-10 flex h-full items-center justify-center px-4">
          <div className="max-w-5xl text-center">
            <h1 className="mb-6 text-7xl md:text-9xl lg:text-[10rem] font-bebas tracking-wider">
              <span className="text-blue-600">TO</span>
              <span className="text-sky-500">DO</span>
              <span className="text-tepoztlan-sunset">TEPOZ</span>
            </h1>
            <p className="mx-auto max-w-2xl text-lg md:text-xl lg:text-2xl text-white mb-8 font-montserrat font-light">
              {lang === 'es' 
      ...
      <div ref={heroRef} className="relative h-screen w-full overflow-hidden">
        ...
        <div className="absolute inset-0 z-[1]">
          ...
          {/* Additional floating elements for directory theme */}
        ...
        <div className="relative z-10 flex h-full items-center justify-center px-4">
          <div className="max-w-5xl text-center">
            {/* Magnetic hover title with staggered reveal */}
            <h1 
              ref={titleRef}
            ...
            {/* Interactive CTA with liquid effect */}
            <div className="mt-12">
        ...
        {/* Premium Scroll Indicator with bounce */}
