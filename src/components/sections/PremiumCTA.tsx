    ...
    <section className="relative py-24 px-4 bg-gradient-to-br from-gray-900 via-purple-900/50 to-gray-800 text-white overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4 font-sans bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent pb-2">
        ...
        <div className="mt-16 flex flex-wrap justify-center gap-8">
          {[
            ...
            <div key={index} className="text-center group cursor-pointer">
              ...
              <div className="text-sm text-gray-400 mt-2 group-hover:text-white transition-colors">
                {stat.label}
              </div>
            </div>
          ))}
