...
export default function TepoztecoPyramidClient({ locale }: TepoztecoPyramidClientProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-50 via-red-50 to-amber-50 dark:bg-gradient-to-br dark:from-slate-900 dark:via-orange-900 dark:to-slate-900 relative overflow-hidden">
      {/* Ultra Premium Background */}
      <div className="absolute inset-0">
        {/* Animated gradient orbs */}
        <div className="absolute top-20 left-20 w-[35rem] h-[35rem] bg-orange-200/40 dark:bg-orange-500/20 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-20 right-20 w-[40rem] h-[40rem] bg-red-200/40 dark:bg-red-500/20 rounded-full blur-3xl animate-pulse animation-delay-2s" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[45rem] h-[45rem] bg-amber-200/30 dark:bg-amber-500/10 rounded-full blur-3xl animate-pulse animation-delay-4s" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-12">
            ...
            <BreadcrumbList>
              <BreadcrumbItem>
                <BreadcrumbLink asChild>
                  <Link href={`/${locale}`} className="flex items-center gap-1.5 hover:text-orange-600 dark:hover:text-orange-400 transition-colors">
              ...
              <BreadcrumbItem>
                <BreadcrumbLink asChild>
                  <Link href={`/${locale}/experience`} className="flex items-center gap-1.5 hover:text-orange-600 dark:hover:text-orange-400 transition-colors">
              ...
              <BreadcrumbItem>
                <BreadcrumbPage className="flex items-center gap-1.5 font-medium text-orange-600 dark:text-orange-400">
                  ⛰️ {locale === 'es' ? 'Pirámide del Tepozteco' : 'Tepozteco Pyramid'}
                </BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-3 mb-8">
            <div className="h-px w-20 bg-gradient-to-r from-transparent to-orange-600 dark:to-orange-400" />
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-orange-600 to-red-600 dark:from-orange-400 dark:to-red-400 blur-lg" />
              <Badge className="relative bg-gradient-to-r from-orange-600 to-red-600 dark:from-orange-400 dark:to-red-400 text-white dark:text-white px-8 py-3 text-sm font-semibold tracking-wider uppercase border-0 shadow-2xl">
                ⛰️ {locale === 'es' ? 'Pirámide del Tepozteco' : 'Tepozteco Pyramid'} ⛰️
              </Badge>
            </div>
            <div className="h-px w-20 bg-gradient-to-l from-transparent to-red-600 dark:to-red-400" />
          </div>
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-8 font-sans">
            ...
            <br />
            <span className="bg-gradient-to-r from-orange-700 via-red-700 to-yellow-700 dark:from-orange-300 dark:via-red-300 dark:to-yellow-300 bg-clip-text text-transparent drop-shadow-2xl">
          ...
          <p className="text-xl md:text-2xl text-slate-700 dark:text-white/80 font-light max-w-4xl mx-auto leading-relaxed mb-8">
            {locale === 'es' 
              ? 'Asciende al templo ancestral del dios Tepoztécatl y descubre vistas panorámicas incomparables del Valle de Morelos.'
              : 'Ascend to the ancient temple of god Tepoztécatl and discover incomparable panoramic views of the Morelos Valley.'
            }
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto mb-8">
            {hikingStats.map((stat, index) => {
              ...
              return (
                <div key={index} className="bg-white/90 dark:bg-white/5 backdrop-blur-xl rounded-2xl border border-orange-300/50 dark:border-white/10 p-6 shadow-2xl">
                  <Icon className={`w-8 h-8 ${stat.color} mb-3 mx-auto`} />
                  <div className={`text-2xl font-bold ${stat.color.replace('400', '600')} dark:${stat.color} mb-1`}>{stat.value}</div>
              ...
              {difficultyLevels.map((level, index) => (
                <div
                  ...
                  className={`w-4 h-4 rounded-full ${
                    level.active ? 'bg-orange-600 dark:bg-orange-400' : 'bg-slate-300 dark:bg-white/20'
                  }`}
                />
              ))}
            </div>
            <Badge className="bg-orange-200/80 dark:bg-orange-400/20 text-orange-700 dark:text-orange-400 border border-orange-400/50 dark:border-orange-400/30">
        ...
        {/* Navigation Tabs */}
        <div className="mb-12">
          <div className="bg-white/90 dark:bg-white/5 backdrop-blur-xl rounded-3xl border border-orange-300/50 dark:border-white/10 p-2 shadow-2xl max-w-2xl mx-auto">
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-2 px-6 py-3 rounded-2xl transition-all duration-300 ${
                      activeTab === tab.id
                        ? 'bg-gradient-to-r from-orange-600 to-red-600 dark:from-orange-400 dark:to-red-400 text-slate-900 dark:text-white shadow-xl'
        ...
        <div className="space-y-12">
          ...
          {activeTab === 'overview' && (
            <div className="grid md:grid-cols-2 gap-12">
              <div className="bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 p-10 shadow-2xl">
                ...
                <p className="text-slate-900 dark:text-white/80 text-lg leading-relaxed mb-6">
                  {locale === 'es'
                ...
                <p className="text-slate-900 dark:text-white/80 text-lg leading-relaxed mb-8">
                  {locale === 'es'
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4 p-4 bg-orange-400/10 rounded-2xl border border-orange-400/20">
                    ...
                    <div>
                      ...
                      <p className="text-slate-900 dark:text-white/70 text-sm">
                ...
                <div className="space-y-6">
                  <div className="group cursor-pointer">
                    <div className="bg-gradient-to-r from-orange-400/20 to-red-400/20 rounded-2xl p-6 group-hover:from-orange-400/30 group-hover:to-red-400/30 transition-all duration-300">
                      ...
                      <p className="text-slate-900 dark:text-white/80">
                        {locale === 'es'
                  ...
                  <div className="group cursor-pointer">
                    <div className="bg-gradient-to-r from-purple-400/20 to-indigo-400/20 rounded-2xl p-6 group-hover:from-purple-400/30 group-hover:to-indigo-400/30 transition-all duration-300">
                      ...
                      <p className="text-slate-900 dark:text-white/80">
                        {locale === 'es'
                          ? 'Sitio ancestral de poder espiritual'
                          : 'Ancient site of spiritual power'
                        }
                      </p>
                    </div>
                  </div>
          ...
          {activeTab === 'hiking' && (
            <div className="bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 p-12 shadow-2xl">
              <h2 className="text-4xl font-bold text-slate-900 dark:text-white mb-8 flex items-center gap-4">
              ...
              <div className="grid md:grid-cols-2 gap-12">
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={index} className="flex items-start gap-4 p-4 bg-white/5 rounded-2xl">
                        <div className="w-8 h-8 bg-orange-400 rounded-full flex items-center justify-center text-slate-900 dark:text-white font-bold text-sm">
                          {point.step}
                        </div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {safetyTips.map((tip, index) => (
                      <div key={index} className="p-4 bg-red-400/10 rounded-2xl border border-red-400/20">
                        ...
                        <p className="text-slate-900 dark:text-white/80 text-sm">
                  ...
                  <div className="mt-8 p-6 bg-orange-400/10 rounded-2xl border border-orange-400/20">
                    ...
                    <div className="space-y-2 text-slate-900 dark:text-white/80 text-sm">
...
{locale === 'es' ? 'Historia Ancestral' : 'Ancient History'}
              </h2>
              <div className="grid md:grid-cols-2 gap-12">
                <div>
                  <h3 className="text-2xl font-semibold text-slate-900 dark:text-white mb-6">
                  ...
                  <p className="text-slate-900 dark:text-white/80 text-lg leading-relaxed mb-6">
                    {locale === 'es'
                      ? 'Tepoztécatl era el dios del pulque, la bebida ritual obtenida del agave. Según la mitología nahua, nació de una doncella que fue fertilizada por el viento. Su templo fue construido en el siglo XIII como un centro ceremonial donde se realizaban rituales relacionados con la fertilidad y la embriaguez ritual.'
                      : 'Tepoztécatl was the god of pulque, the ceremonial drink obtained from agave. According to Nahua mythology, he was born from a maiden who was fertilized by the wind. His temple was built in the 13th century as a ceremonial center where rituals related to fertility and ceremonial intoxication were performed.'
                    }
                  </p>
                  <p className="text-slate-900 dark:text-white/80 text-lg leading-relaxed">
                    {locale === 'es'
                ...
                <div>
                  <h3 className="text-2xl font-semibold text-slate-900 dark:text-white mb-6">
{locale === 'es' ? 'Arquitectura Ancestral' : 'Ancient Architecture'}
                  </h3>
                  <div className="space-y-4">
                    <div className="p-4 bg-orange-400/10 rounded-2xl">
                      <h4 className="text-slate-900 dark:text-white font-semibold mb-2">🏛️ {locale === 'es' ? 'Estilo Teotihuacano' : 'Teotihuacan Style'}</h4>
                      <p className="text-slate-900 dark:text-white/70 text-sm">
                    ...
                    <div className="p-4 bg-red-400/10 rounded-2xl">
                      <h4 className="text-slate-900 dark:text-white font-semibold mb-2">🔺 {locale === 'es' ? 'Pirámide Escalonada' : 'Step Pyramid'}</h4>
                      <p className="text-slate-900 dark:text-white/70 text-sm">
                    ...
                    <div className="p-4 bg-yellow-400/10 rounded-2xl">
                      <h4 className="text-slate-900 dark:text-white font-semibold mb-2">🌟 {locale === 'es' ? 'Orientación Astronómica' : 'Astronomical Orientation'}</h4>
                      <p className="text-slate-900 dark:text-white/70 text-sm">
          ...
          {activeTab === 'tips' && (
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 p-8 shadow-2xl">
                ...
                <ul className="space-y-3 text-slate-900 dark:text-white/80">
              ...
              <div className="bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 p-8 shadow-2xl">
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-green-400/10 rounded-2xl">
                    ...
                    <p className="text-slate-900 dark:text-white/70 text-sm">Nov - Abr</p>
                  </div>
                  <div className="p-4 bg-blue-400/10 rounded-2xl">
                    <h4 className="text-slate-900 dark:text-white font-semibold mb-1">
                      {locale === 'es' ? 'Horario Ideal' : 'Ideal Time'}
                    </h4>
                    <p className="text-slate-900 dark:text-white/70 text-sm">6:00 - 10:00 AM</p>
                  </div>
              ...
              <div className="bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 p-8 shadow-2xl">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-slate-900 dark:text-white/70 text-sm">911</p>
                  </div>
                  <div>
                    <h4 className="text-slate-900 dark:text-white font-semibold mb-2">
                      {locale === 'es' ? 'Guardaparques' : 'Park Rangers'}
                    </h4>
                    <p className="text-slate-900 dark:text-white/70 text-sm">739 395 0525</p>
                  </div>
                  <div>
                    <h4 className="text-slate-900 dark:text-white font-semibold mb-2">
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-orange-400/20 to-red-400/20 backdrop-blur-xl rounded-3xl border border-white/10 p-12 shadow-2xl max-w-4xl mx-auto">
            ...
            <p className="text-slate-900 dark:text-white/80 text-xl mb-8 max-w-2xl mx-auto">
              {locale === 'es'
                ? 'Únete a miles de aventureros que han conquistado esta montaña mística y descubierto su magia ancestral'
                : 'Join thousands of adventurers who have conquered this mystical mountain and discovered its ancestral magic'
              }
            </p>
